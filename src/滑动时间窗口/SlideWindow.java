...
public class SlideWindow {
        ...
        public static void main(String[] args) throws InterruptedException {
            while (true) {
                // 任意10秒内，只允许2次通过
                System.out.println(LocalTime.now().toString() + SlideWindow.isGo("ListId", 1, 3000L));
                // 睡眠0-10秒
         ...
         * @param listId     队列id
         * @param count      限制次数
         * @param timeWindow 时间窗口大小   越小越精确
         * @return 是否允许通过
         */
        public static  boolean isGo(String listId, int count, long timeWindow) {
            // 获取当前时间
            ...
            if (nowTime - farTime <= timeWindow) {
                ...
                synchronized(SlideWindow.class) {
